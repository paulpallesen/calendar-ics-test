...
for name, group in grouped:
    ...
    cal = Calendar()
    cal.extra.append(ContentLine(name='X-WR-CALNAME', value=str(name)))  # Use ContentLine for custom properties
    cal.extra.append(ContentLine(name='X-WR-TIMEZONE', value='Australia/Sydney'))  # Use ContentLine for custom properties
